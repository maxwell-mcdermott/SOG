...
# changed to incorporate ideal Cut and Tag parameters
...
echo "#SAMPLE,TOTAL READS,MAPPED READS %,CHR M READS %,MAPPED READS MQ30 %,ECOLI" > "$summary_csv"

# summarize log file
echo "${sample},${reads_input},${reads_mapped_pct},${reads_chrM_pct},${reads_filtered_pct},${seqDepth}" >> "$summary_csv"
